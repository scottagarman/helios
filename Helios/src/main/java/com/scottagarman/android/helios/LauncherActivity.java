...
public class LauncherActivity extends FragmentActivity implements ActionBar.TabListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("Helios/", "Calling listBridges()");
        HueApiService hueApiService = HueApi.getHueApiService();
        hueApiService.listBridges(new Callback<ArrayList<HueBridgeModel>>() {
            @Override
            ...
            public void failure(RetrofitError retrofitError) {
                Log.d("Helios/", "Error: " + retrofitError.toString());
            }
        });
    }
